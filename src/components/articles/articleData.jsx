export const articlesContent = {
  ...
  // Source: http://marriagecounselornj.com/marriage-counseling-dr-gross-teaneck-bergen-nj/i-brief-overview/
  'brief-overview': {
    title: 'Brief Overview of the Marriage and Couple Counseling Process',
...
Since I am not part of a hospital or psychological clinic, but rather a marriage counselor and psychologist in private practice, when you call my office, you speak directly to me. I’ll be happy to spend time with you, at no charge, sympathetically exploring your reasons for inquiring about marriage, pre-marital or individual counseling. If you wish, we can arrange an appointment at that time, or if you prefer, you can talk it over with your spouse and call me back. If your spouse/partner is unwilling to come, it may be even more important for you to come and start the process. When we meet, I will help you explore new approaches to alleviate the situation; hopefully, your spouse to join you in the process of fighting for the success of your relationship and help you explore options that you may not have considered. Please click here for articles on “Spouse Resists Counseling.“

## B. Questionnaire

Prior to my meeting with a couple, I send a number of carefully crafted questionaires which I created over the years as email attachments to each couple. Please make two copies of each questionaire so that you and your partner will be able to fill them out privately. Please make a copy for me of everything you both write, and bring the original as well as a copy for me to the first session. The questionnaires ask about the nature of your relationship with your spouse, your level of satisfaction in different areas, the adequacy of your communication, and your wishes for change. This time- and cost-effective exercise affords both of you an opportunity to organize your thinking so as to make maximum use of the time spent with me at our first meeting. You bring your written responses to the initial session. Your answers give me a wealth of information which saves us many hours of exploration and interview and gives us a jump-start in the counseling process. This information helps us in formulating our agenda and counseling and serves as a baseline for evaluation of progress at future meetings.
...
The purpose of homework assignments is to enrich our sessions, extend the impact of each session, and maintain momentum from meeting to meeting. Sometimes I assign tasks that require written responses to help you explore yourself, your partner, your interactions and to evaluate important themes in your marriage. The information elicited by this approach enriches the material that you bring up during our counseling sessions and is used during subsequent meetings as a map and guide for our work together. At other times, I assign specific activities for you to do (including reading) as well as the weekly “business meeting.” which you have with each other to augment the work that we do in a session.
  ...
  // Source: http://marriagecounselornj.com/marriage-counseling-dr-gross-teaneck-bergen-nj/why-isnt-love-enough/
  'why-isnt-love-enough': {
    title: 'Why Isn\'t Love Enough?',
    category: 'marriage-counseling-process',
    categoryName: 'Marriage Counseling Process',
    articleNumber: 'II',
    content: `
...
Talking is uttering words with the goal of getting a message across; sometimes it works, sometimes it doesn’t. Communicating refers to one step further in the process: it is the successful transmission of a message. When a person talks to their partner and there is no communication, the relationship will suffer.

This article has eight sections labeled 1–8.

Overview of The Marriage & Couple Counseling Process
...
Separation Can Spark the Adrenaline Surge
...
My approach during counseling sessions reflects an amalgamation of theories and procedures that I have learned from others, and techniques that I have developed on my own in the course of seeing more than two thousand couples over the past 39 years. Based on your answers to the questionnaires that I sent you before we even met and your statements at our first session, we got down to business at our very first meeting. My approach is active, direct, action- and results-oriented, and flexibly responsive to the specific needs of each couple.
...
Session content includes topics that are brought up by each of you, as well as an exploration of the answers you gave in response to the initial questionnaire that I sent you before the first session.

This article also enumerates some of my theories about the necessary ingredients for a happy couple relationship. It describes my ongoing efforts to promote a process of self-discovery and self-revelation with both spouses so that each person may gain a better understanding of himself and his partner, as well as insight into the psychodynamics of their interaction.

The article describes some of the techniques that I demonstrate (and have the couple practice during the counseling session), which will help them solve the problems that brought them to therapy. As a follow-up to our sessions together, I give at-home assignments to each couple when spending a minimum of quiet time with each other nightly, having a weekly “business meeting,” and reading articles or even books.

The Goal of the Marriage Counselor

The ultimate goal of the marriage counselor is to give you the tools to solve as many issues as possible with each other that are eating away at your happiness. Now, even if a problem cannot be totally solved, with a new perspective, the comparative magnitude of the problem can usually be lessened, and the negative emotions attached to the arguments/fights can usually be eliminated or greatly reduced.

Although the reader is welcome to employ the ideas and exercises presented here to his/her benefit, this article was designed as an overview of my approach to marriage counseling rather than as a self-help article. Many of the techniques described here work much better when they are explained and acted upon under the guidance of the counselor with a discussion centering on how these techniques might best be adapted—and implemented, to serve the specific needs of each couple.

## 2. Why Do Individuals Initiate
Marriage Counseling?
...
The level of unhappiness varies among couples and sometimes within the couple. People sometimes come because they have not achieved much success in their efforts to solve a particular nagging problem, but more frequently, to address a number of problems that are causing them distress.

People who come for professional help realize that they have exhausted their own efforts at remediation and are looking for the light at the end of the tunnel. In a moderate situation, they see themselves stuck in a less-than-happy situation; in a worst-case scenario, they are rapidly losing patience, hope, and fear of the dissolution of their relationship. Although there is no guarantee that counseling will help, they are making the right decision. Studies show that most couples report very positive results from their counseling experience.

## 3. Individuals Differ From Each Other

## Section 3 of Article 3

The fact is that no two individuals are the same, not only in their DNA, but we each have one hundred billion neurons in our brain, containing very different experiences, memories, attachments, habits, philosophies, etc. Thus, it is axiomatic that no two persons (or couples) who come for counseling are the same in terms of their personalities, interpersonal skills, and other dimensions that come to the fore during the counseling process.

These differences also include the nature of the relationship difficulties, the chronicity and severity of the problems,

the duration and depth of each person’s unhappiness, the willingness of each person to admit to his contributions to the situation, his willingness to commit to the process of counseling, and his staying power.

Other differences between individuals and therefore, within couples, include: emotional sensitivity, capacity to see the situation from spouse’s point of view, intensity of disrupting emotions (e.g., anger), flexibility of each partner (ability to learn new ways of relating and changing old ways), and the strength of each person’s desire to enhance their partner’s welfare and happiness.

Differences in The Male/Female Dimension

Differences between males and females have been described by John Grey, Ph.D., a psychologist with many years of experience working with couples, in his best-seller “Men Are From Mars: Women Are From Venus.” The most up-to-date research on the brain has demonstrated notable differences in brain structure between men and women.
...
When a couple makes their first appointment, it is the dawn of a new life. I send each person twenty-three pages of questionnaires via email. Completing the questionnaire provides each person with an opportunity to organize and put his/her thoughts about the relationship on paper. The questionnaires are filled out at home and brought by the couple to the first session.

Some of the questions are specific, e.g., How well do you understand when you discuss personal relationship issues? How successful are you at resolving differences, or do they turn into fights? How critical are you of each other? Are your opinions and feelings respected? Feel alone in the relationship? How often do you express love, gratitude, or praise to each other? etc….

The next group of questions is open-ended. For example, on the “Wish List,” each person is encouraged to express their specific wishes regarding their partner. Spouses are asked to make as long a list as they desire for hoped-for behaviors from their partner, such as more attention, understanding, respect, support, affection, sex, etc. In another exercise, each person is asked to list those negative behaviors of their partner that they could do without because they annoy, anger, or hurt them, e.g., yell, criticize, minimize or ignore their partner’s feelings or opinions, reject sexually, etc. Other questions follow.

By the time the couple comes to their first appointment, they have clarified a good part of their thinking and have already established some of their agenda and goals in counseling. I have found the use of advanced questionnaires to be time-effective as well as cost-effective. This approach is especially efficient for persons who might be intimidated or nervous in the presence of a marriage counselor.

However, the approach has universal value since the couple is freed from the task of digging into their psyche on the spot and coming up with a litany of complaints or an analysis of their situation the moment they walk into my office.
...
In some situations, both partners are fairly equally unhappy in the marriage and similarly accusatory of their spouse’s shortcomings. At other times, one person is unhappier or accusatory than the other. The questionnaires that are filled out prior to the initial meeting give each person an opportunity to air their complaints and, in the process, give their partner the keys (road map) to the solution.

In session, we read aloud, in a quiet, peaceful manner, the sources of each person’s unhappiness and their detailed expression of needs and wishes that they would like their partner to satisfy. During the airing of each person’s complaints or “Wish List,” the counselor will not allow yelling, insulting, changing the topic, counter-accusing, or any of the negative behaviors that the couple might be exhibiting at home. Nor will the counselor permit interrupting.

When one person is talking, the listener might be provided with a notepad so that they will better remember what the speaker is saying. If he puts his comments on paper, he will be in a better position to respond appropriately. Neither partner is allowed to hog the conversation. If “fighting” is one of the couple’s complaints, The Nineteen Rules of Good Communication are introduced and put into effect at the very first session.
...
We also explore how these needs and behaviors interact with his partner’s needs, wishes, and behaviors. All marriages are dynamic. In the counseling process, partners become acutely aware of the healthy as well as unhealthy interplay and reciprocity of their relationship and are helped to increase their healthy, positive, mutually supportive, and loving behaviors.

## 5. How Does Marriage or Couple Counseling Help

## Section 5 of Article 3

A good portion of couples who come for help complain of frequent fights. Not only does rational discussion go to the winds and problems can’t be solved that way, but the activity of yelling, accusing, insulting, etc, that accompany these fights poison the atmosphere and make cooperation and accommodation less likely.

Counseling opens both partners’ eyes to the significance and reciprocal nature of their own and their partner’s behaviors and attitudes, and gives them new perspectives on cause and effect in their relationship. By understanding the psychodynamics of their interactions, the couple learns how their neglectful/avoidance or negative/hurtful behaviors make matters worse and contribute to a vicious cycle.

In such cases, the marriage counselor encourages each person to stop adding fuel to the flame (if fighting, neglect, or passive-aggressive behavior is one of their complaints). The point is made that two wrongs don’t make one right, and that reacting to a provocation with a provocation only makes things worse.
...
In my practice, one of the first things I introduce to the couple is a list of 19 rules of good communication. For example. Rule #1 forbids verbal (insults, name-calling) or non-verbal (making a face, rolling eyes) put-downs. The desired behavior is to show respect at all times. Another no-no is interrupting. A third no-no is failure to give your spouse your undivided attention when listening. A fourth no-no is raising one’s voice angrily, etc. My next step is to get the couple to agree to the wisdom of the nineteen rules and promise to do their best not to violate them.

Couples that adhere to these rules are amazed at how quickly they change the atmosphere in their household. My next approach in marriage counseling is to teach the couple problem-solving. They learn how to complain, disagree, and solve complex and sensitive situations respectfully and constructively. These new skills open channels of communication that the couple has never used before.
...
Showing constant respect for the partner’s feelings, opinions, and personhood.

Actively displaying unstinting love, care, and concern for the partner’s needs for acceptance, support, affection, and sex.

Frequent expression of recognition, appreciation, thanks, and praise for the partner’s personal qualities, his/her contributions to the enhancement of the relationship, extended family and social life, financial support, care for the children, management of the household, etc.
...
I reinforce these concepts by introducing specific interactive behaviors that many couples have barely considered in the past, much less put into practice. These might include keeping a brief diary of positive and well as negative behaviors by each spouse, daily quality-time meetings with each other to discuss the day and the relationship, a “business meeting” once a week, etc.

My approach is to assign at-home exercises to the individuals who require the use of these newly learned problem-solving, empathic, caring, and bonding behaviors. The sooner the couple puts these principles into practice, the sooner the old feelings of love and closeness are awakened and the sooner the relationship is back on track.

## 6. Spouses Look into the Mirror

## Section 6 of Article 3:

In Addition to Focusing on Their Spouse’s Problems, We Encourage Each Person to Face Their Own Problem(s) Squarely in The Face.
...
As the marriage counseling process unfolds, we ask each person to look in the mirror. One of the exercises he/she will be asked to do involves making as long a list as he/she can of his/her own behaviors in response to the statement “Deep in my heart I know that I would be a better spouse if I would do the following for my spouse…” (list all the positive behaviors that would please your partner).

The next exercise continues the self-searching as follows: “Deep in my heart, I know that I would be a better spouse if I did not do the following…” (list all of your behaviors that annoy or antagonize your partner).
...
At this point, we also examine the appropriateness or effectiveness of the complainer’s usual responses to his spouse’s provocations. Does he know how to defuse a provocative statement or behavior, either by doing something positive:

a) “Blowing the Whistle” on the other person, thus bringing attention to his spouse’s violation of respectful conduct during an argument, and/or
b). directly address the legitimate part of the upset spouse’s complaint and ignore (for the moment) the provocative manner? Or does he do something negative by:

b) Adding fuel to the flame by responding to negative/provocative behaviors in kind? Do two wrongs make one right?
...
I also work with couples who are separated. Are there any advantages to separation? Often, separation serves as an advantage to the process of reconciliation. Distance usually gives a person a different perspective. The problems may seem more bearable and even solvable. The attractions of the marriage may appear stronger and take on greater importance.

With a new perspective, both parties might show a greater acceptance of their spouse’s demands and lower their own expectations and demands. They may also take a more realistic view of their own shortcomings and faults. If so, they will look at the process of compromise in a new light.

A higher level of motivation results in greater effort on the part of each individual to develop a lasting relationship that is based on a realistic understanding of their partner’s agenda, even if it differs from what they originally thought it was, and even if their partner has changed his agenda as he matured and the marriage progressed.

In such cases, as the partners begin to reconcile, the anger that they had for each other and the despair that they had for the relationship when they first separated slowly abate. The original attraction begins to reassert itself, and the partners begin speaking to and seeing each other more frequently, going out, and spending more nights together.

Both individuals now miss, more and more, the togetherness that they once had. They express their sorrow at being apart and begin to explore the possibility of living together again. Children, family/friend encouragement, finances, and other reasons may also contribute to the goal of reuniting.
...
## Section 8 of Article 3: There is No Magic Wand
...
Show care for the partner rather than selfishness, indifference, or animosity toward the partner’s needs.
...
The name of the game is perseverance and hard work. With goodwill and sustained effort, most problems can be solved, and the relationship can be restored to the full satisfaction of both partners. Individuals can learn how to bring out the best in themselves and in their partners. When happy interactions are initiated, they are self-reinforcing, and a benign cycle replaces the vicious cycle that brought the couple into counseling.

A successful marital counseling experience is eye-opening for both individuals. The experience with the counselor can bring the couple into a more mature, joyful, happier, richer, wiser, and fulfilling relationship than they had ever experienced before, even better than when they first met.
  `
  },
  // Source: http://marriagecounselornj.com/marriage-counseling-dr-gross-teaneck-bergen-nj/assessing-happiness/
  'assessing-happiness': {
    title: 'Assessing Each Person\'s Feelings About the Relationship',
    category: 'marriage-counseling-process',
    categoryName: 'Marriage Counseling Process',
    articleNumber: 'IV',
    content: `
...
I am indebted to her for her analogy: “We’re like two people in a rowboat. It doesn’t matter under whose seat there is a hole. If we don’t plug up the hole, we’ll both go down.”
  ...
  // Source: http://marriagecounselornj.com/effective-communication/how-to-complain-diplomatically/
  'how-to-complain-diplomatically': {
    title: 'Avoid Fights and Keep the Peace: Complain and Even Argue in a Friendly Manner',
    category: 'effective-communication',
    categoryName: 'Effective Communication',
    articleNumber: 'I',
    content: `
Angry complaints and insulting or nasty arguments will weaken your relationship while freiendly ones will strengthen it. This article addresses the issues of couples who say, “We have a communication problem, we’re always fighting.” This article describes how, in a reasonably short time, couples can master respectful arguing skills, which will result in successful complaint and problem-solving skills, which are crucial ingredients for mutual understanding and a harmonious relationship.
...
Couples who say about themselves, “We have a communication problem,” “We can’t communicate,” or “We’re always fighting,” generally mean that they do not problem-solve effectively. In these couples:

1. When a partner wishes to have a positive, constructive discussion on how to address a thorny problem that they both recognize,
or
2. An attempt to have a respectful solution-seeking argument on how to proceed in a specific situation where they know that they disagree, and to reach a happy compromise,
or
...
In other cases, the fighting is less frequent, but it is a constant menace that hovers over them and erupts whenever there is frustration, disappointment, or a difference of opinion. Many individuals have reached a point of exhaustion in their fighting or a sense of futility in their ability to resolve differences to the point that they “swallow their problems” and keep their thoughts to themselves. They avoid raising (even reasonable) complaints or discussing problems for reasons of self-preservation. They see their withdrawal from each other as the only approach they know to avoid fighting.
...
When the fighter does listen, he might do so impatiently, with half an ear, and maybe quick to demean, minimize, or discount the value of his opponent’s facts, feelings, or opinions. The fighter might also be sarcastic, insult the other person’s intelligence, use verbal or nonverbal techniques (make faces, roll eyes) to express anger, belligerence, or disdain.

Opposite of the arguer is the fighter. The attitude of the fighter is “I’m right, you’re wrong” and “I know what I’m talking about, you don’t.” With domineering individuals, the attitude is “It’s my way or the highway.” The fighter or controlling person is looking to impose his wish upon the other person and is shooting for a win-lose situation.
...
Couples who go through this experience are amazed at how easy it is to violate the nineteen rules when initiating, even a legitimate complaint. In fact, they frequently identify with the couple in the script, that the wife’s concern about speeding did not begin as a polite request for her husband to slow down. Unfortunately, her loud commands began a full-fledged fight. It went from 0-100 in a split second.

As we analyze the give and take of the ensuing battle in the script, during couples therapy, the patients who are working with me are impressed at … how rapidly they become proficient at spotting violations of the “husband” and “wife” whom they are representing, how easy it would be in the future (now that they have the benefit of instruction) to a. avoid a fight in the first place, and how to stop a fight cold, should one of the partners initiate one.
...
In an argument, both people politely state their position, give their reasons or supporting evidence, and listen carefully to their partner’s explanation of their position.

In a fight, they rarely do any of the above. In an argument, both people are open to new ideas and are willing to modify or switch their position.

In a fight, the participants are close-minded to new ideas and rigid in their stance.

In an argument, the participants are not ego-involved with their positions. In a fight, their ego is involved.
...
After a fight, both contestants are frustrated, disappointed, and alienated. They may also be hurt, and surely angry because of what was said (and because of what should have been said, but was not). And for all their time, effort, and energy, not only has nothing been solved, but they are worse off now than they were when they began.
...
In a marriage—or any friendly relationship, the goal should always be a win-win. A win-lose situation is equal to a lose-lose situation.

## B. The Important Role of an Argument in Relationships

## B. 1. Salient Features of an Argument

A constructive or friendly argument is characterized by a respectful exchange of ideas by people who differ on how to identify or address a problem. Each person tries to convince their partner that he is right by a logical presentation of credible evidence, including facts, logical reasons, past personal experiences, reports from people who have solved similar problems, expert opinions, or recommendations from reliable sources, etc, to justify their point of view. This is good. There is nothing wrong with believing that you are right, nor in pushing your point of view by respectful attempts to put forth your reasons for your position so as to win over your partner to your point of view.

In many situations, personal preferences rather than logical justifications are placed on the scale. In such cases, this should be clearly stated and weighed in by the partner with respect and care as an emotional factor quite apart from logic and reason. In a friendly argument, neither partner is glued to their position, and both listen carefully to their opponent’s views.

Both have open minds and are willing to be convinced that their position should be modified or even abandoned. Most important: friendly arguers are not ego-involved in getting their way, but are looking for a solution to the problem that is agreeable to both, i.e., a win-win situation.

## B. 2. Arguing is Good

Unfortunately, arguments between individuals, especially between people who are related, live with each other, or are otherwise emotionally involved, tend to become heated and deteriorate into fights. Consequently, the word argument has taken on negative connotations in our culture. When a person says, “I don’t want to argue,” he really means, “I don’t want to fight.” But in fact, people can argue without fighting. Webster defines “argument” simply as “debate or discussion in which there is disagreement.” The word has no negative connotations. During couples’ therapy, I explain that the word simply means an exchange of ideas by people who differ in their opinions; there is no reason why arguments cannot be friendly.

When an argument is used as a tool by spouses to solve their problems or resolve their differences, it can be a most constructive and solution-seeking behavior. Consequently, whenever there is a difference of opinion, an argument is a good thing to have. How else can people solve their differences? An argument is good; a fight is bad.

## B. 3. The Need to Argue, The Importance of Arguing, The Beauty of Arguing

Since it is most unlikely that two people will have the exact same opinion on everything, and each person usually wishes to further his point of view (and is entitled to do so), arguments are inevitable and indeed helpful. In a solution-seeking argument, both people will emerge with more knowledge about the subject discussed than before the argument began and might be glad (or even grateful) that they were exposed to contrary facts and alternate solutions.

After a good argument, the couple may arrive at a solution that both agree is better than the original position of each person. At worst, each person may still believe that his own original position is excellent, but since his partner opposes that approach, the couple will arrive at a solution that is acceptable to both. When an argument ends, especially a good, long one that may have dragged on for days, weeks, or even months, both parties may be weary, but they are satisfied and are on friendly terms with each other.

The final plan, solution, or decision will have been arrived at jointly, perhaps laboriously, but at least peacefully and with goodwill.

## C. Five Specific Good Characteristics of an Argument
...
## C. 1. Both Spouses Express Their Views and Give Their Reasons

A couple agrees to take their vacation at a hotel but disagrees as to which hotel. In an argument (as distinct from a fight), both spouses listen to each other’s point of view and their reasons for making that choice. In this case, the husband argues for hotel “A” because he likes the golf course on campus, and the wife argues for hotel “B” because she likes their spa, steam room, and pool.

The wife might try to entice the husband to her hotel by reminding him of her hotel’s excellent tennis instructor, and the husband might entice the wife to his hotel by reminding her of the ballroom dancing program at his preferred hotel.

## C. 3. Both Spouses Are Open to a Rebuttal of Their Counterargument

Scenario Two: When the husband counters that the mosquito problem was last August and their proposed trip is in December, the wife drops her objection. When the wife counters that the food problem no longer exists because her friend reported that the wife’s preferred hotel has a new chef and the food is excellent, the husband drops his objection. Both show an open mind for a counterargument to their original objection.

## C. 4. Each Spouse is Willing to Accommodate the Other

Scenario Three: What happens now? Since both hotels are now back in the running, and neither spouse has an objection to the other’s preference, the situation presents the couple with an excellent opportunity for accommodation and demonstration of a desire to please. For example, the husband might say: I know how important the spa and steam room are to you, so let’s go to your hotel and I don’t mind driving ten minutes to the nearest golf course.

Or the wife might say, “I know how much you enjoy ‘A’s golf course, and since they have a good spa and a nice swimming pool, I’ll forgo the steam room this time. In this scenario, the selfless person did so on his own initiative, and both partners are comfortable with the decision. The accommodating spouse has built up goodwill.

## C. 5. Couple Argues in a Friendly Manner and Reach a Happy Compromise
...
## C. 6. Exceptions to the Rule

Understandably, the example cited above is fairly straightforward and comparatively easy. Many of life’s problems are considerably more complicated and do not lend themselves to easy solutions. Further, in some situations, feelings ride high because of the chronic nature of the problem to be solved or past hurts and lingering feelings of resentment for having been ignored, hurt, or angered in the past by the spouse (or by a previous partner, or even by a parent). Understandably, adding negative emotional components to the argument complicates matters.
...
Thus, a new spirit of cooperation and friendliness takes hold and sets the stage for the more difficult steps, e.g., self-revelation, careful listening, mutual understanding, care, and compassion, that must be taken to address the various negative behaviors, harmful interactions, and underlying relationship deficits that must be modified, and needs that must be met.

As we begin resolving these underlying problems, we reduce the secondary consequences of those problems, viz., the hurt, disappointment, ill will, anger, etc., and other negative emotions. We have now stopped the vicious cycle and have begun a benign cycle. The cycle of resentment and indifference—or worse, anger and spite, which elicits more negative behavior or separation and indifference gives way to a spirit of mutual concern, cooperation, and bonding.

Changing the mode of interaction from fighting to cooperating brings the couple so much closer to their goals of living in peace, harmony, and love with each other. Yes, it can be done!

## C. 2. Both Spouses Are Open to Their Mate's Objections or Counterarguments

Scenario One: This argument can play out in a number of ways. When wife reminds husband of the mosquito problem they had previously experienced at his preferred hotel, and husband reminds wife of the poor food problem they had both experienced at her preferred hotel, they both admit the accuracy of their spouses’ objection to their preferred hotel, willingly give up their original positions, and jointly choose hotel “C.”

They are both happy that they had the argument because they are now better off than they would have been had they not exchanged their views and learned (in this case, we’re reminded about something they had forgotten) about the weakness of their original position.
...
Of course, many problems that couples face are much more complicated than this, but the basic principles stand. When people express their position, give their reasons for it, and are open to information from their partner, they will sometimes learn the weaknesses of their own position (in this case, the mosquitoes or the poor food), and at other times learn the strength of their opponent’s position (tennis instruction, ballroom dancing). In the end, they will weigh all the pros and cons and will generally end up with a solution that is better than their original choice.
  ...
  // Source: http://marriagecounselornj.com/effective-communication/4-i-the-difference-in-talkingcommunicating/
  'talking-isnt-communicating': {
    title: 'Talking Isn\'t Always Communicating',
    category: 'effective-communication',
    categoryName: 'Effective Communication',
    articleNumber: 'II',
    content: `
...
For good communication to take place, the discussants are not required to agree on the spot or come to an immediate solution to the problem. They are only required to express honestly, clearly and respectfully what is on their minds, and listen carefully to each other so that they will understand what is on their partner’s mind. Good communication is the first step in problem-solving and relationship building.
  ...
  // Source: http://marriagecounselornj.com/effective-communication/5-iia-a-b-c-should-always-be-the-same/
  'abc-should-be-the-same': {
    title: 'The A-B-C\'s of Good Communication: A, B, & C Should Always Be the Same',
    category: 'effective-communication',
    categoryName: 'Effective Communication',
    articleNumber: 'III',
    content: `
...
,  // Source: https://marriagecounselornj.com/effective-communication/3-b-six-reasons-why-a-b-c-are-harmful-when-not-the-same/
  'abc-not-always-the-same': {
    title: 'Communication Fails When A, B, & C Are Not the Same',
    category: 'effective-communication',
    categoryName: 'Effective Communication',
    articleNumber: 'IV',
    content: `
## Explanation of A, B & C
1. The A is the complex intertwining of thoughts and feelings that lie within the speaker’s mind and heart.

2. The B is the exact words that are said to the listener. It also includes the manner in which it is said, including tone of voice and body language. If B = A, then the speaker did his part to accomplish a successful communication. However, if B is ambiguous,  or uttered with a tone of voice or body language that differs from the speaker’s exact thoughts and feelings, the speaker has failed to communicate accurately.

3. The C refers to the words, thoughts, and emotions as they are understood by the listener. If the C is exactly like the B, good communication is taking place. But sometimes the listener misunderstands, misinterprets, or simply understands the ambiguous B differently than the speaker meant his words to be, or if the listener fails to hear the B as it is uttered, a misscommunication has taken place.
...
1. Poor Communicators Do Not Reveal The Complexity of Their Emotional State; They Reveal Only Part of What is Going On Inside of Them, Hence Their B is Not The Same as Their A Click here
2. Communication Breaks Down When C is Not The Same as B Due to:
1. Inattention,
2. Selective Hearing, 3. Misinterpreting, or Mind Reading on the part of the listener. Click here
3. People Miscommunicate Under The Influence of Anger; Their B is Not The Same as Their True A
1. Using the “Never” word, 2. Using the “Always” word, 3. Making a blanket statement, and 4. Name- calling. Click here
4. It is Poor Communication When The Speaker Knowingly Distorts What He Truly Believes or
Feels in His Heart. His B is Not The Same as His A. Click here
5. It is Poor Communication When B is Not The Same as A due to an Honest Mistake on the Part of the Speaker. Click here
6. Other Reasons Why Misinterpretation Takes Place: 6a. The Role of the Speaker  6b. The Role of the Listener Click here
...
Inattention
## Reason 2 (a). Illustrating When C is Not the Same as B Due to an Ambiguous B
In the cartoon showing a male talking to a female, the male intended to be nice by making two statements: 1. He apologizes for something that happened in the past and 2. He loves her. A miscommunication took place because he did not pause or change his voice or tone between the two statements and she heard both of his intended positive statements as one negative statement viz. “I am sorry I love you.”
For a real life example that I experienced in my office of an unfortunate difference between the speaker’s positive feelings, his A, and his B in which his exact words to his partner were identical to his A, but here his manner of speech was ambiguous enough so that his partner misunderstood him and saw it as a single negative statement. His A was two positive statements: 1.Things are much better now and 2.You are warmer. But his wife heard these two positive statements as one negative statement. He was blaming her for the problems that brought them to marriage counseling because she had been cold and things were better now after a few sessions of counseling because she became warmer.
## Reason 2 (b). Illustrating When C is Not The Same as B Due to Selective Hearing
...
BUT DUE TO SELECTIVE HEARING, HE HEARS ONLY THE CAPITALIZED WORDS:
“GO to the store; LAY DOWN the mulch; wash AND wax the car; GET the kids at school; rent SOME videos; and finish the REST of the dishes.”
## Reason 2. (c). Illustrating When C is Not The Same as B Due to Misinterpreting or Mind-Reading
...
## Reason 5 (b). Sloppy Thinking or Sloppy Articulation:
...
But what if the speaker’s B is ambiguous or vague and his words can truly be interpreted in more than one way? In such a case, who is to blame for the breakdown of communication? Is it solely the speaker’s fault because he was ambiguous? Or is the listener partly to blame for not sensing that the statement could be interpreted in more than one way and fails to ask for clarification? Let’s explore both possibilities.
## Reason 6 (a). The Speaker's Role in Avoiding Misinterpretation
...
After talking, the speaker should not have assumed that her message was transmitted accurately and her B did not reflect her friendly A. Unfortunately, since her partner heard her B as a negative accusation. It is sad to say, her B was not equivalent to her friendly A. Her listener heard her statement as a negative accusation and responded accordingly. Sicne the listener heard a negative accusation, he responded with anger. The listener did not understand that her words were misunderstood in that he heard it as an agry accusation. She did not know this and expected a fiendly reaction to her statement, a facial expression, nod of the head, or better still, a verbal response from the listener that is pertinent to what was just said.
...
## Reason 6 (b). The Listener's Role in Avoiding Misinterpretation
...
As noted at the beginning of this article, neither gender wins an Emmy for communication. In all of the communication errors cited here all of my points are relevant to both genders.
  `
    ...
    // Source: http://marriagecounselornj.com/effective-communication/7-iii-6-important-benefit-of-good-communication/
  'benefits-of-good-communication': {
    title: 'Six Important Benefits of Good Communication',
    category: 'effective-communication',
    categoryName: 'Effective Communication',
    articleNumber: 'V',
    content: `
...
## 1. Avoid Misunderstandings, Fights and Emotional Separation
...
5. Engage in Frank Discussions in Which Each of You
a) Reveals to Your Partner Your Agenda of Needs, Wishes, and Expectations
b) Develops a Clear Understanding of How to Fulfill This Agenda to Your Partner’s Satisfactions
...
Teach you the nineteen positive behaviors that will keep an argument on track, and elaborate on the nineteen negative behaviors that are destructive to successful arguing.
...
Having completed this task, they then engage in an interactive exercise in which each person reads one item at a time from his list of expectations. He will then ask his partner whether he/she considers this expectation reasonable and appropriate and whether the partner is capable and willing to fulfill this particular request. This exercise will be elaborated upon later in this article.
...
If, in spite of a person’s disillusionment, frustrations, and the pain that he has suffered in his marriage, if that person is still willing to invest time, effort and himself to meet the challenge of getting into marriage counseling and meeting his problems head-on, it may very well be because that individual believes with me that for all of its faults, the marital framework is still the best structure known to mankind within which people can grow in their ability to give and receive love, and develop selflessness, empathy, and compassion for others. Moreover, within this framework, men and women can both achieve an abundance of satisfaction, support, and personal fulfillment, as well as children, if they so desire—all of which adds meaning to their lives, and ultimately deep happiness.
  ...
  // Source: http://marriagecounselornj.com/effective-communication/reasons-why-spouses-fail-to-communicate/
  'reasons-spouses-fail-to-communicate': {
    title: 'Thirteen Reasons Why Spouses Fail to Communicate Effectively',
    category: 'effective-communication',
    categoryName: 'Effective Communication',
    articleNumber: 'VI',
    content: `
...
## 1. Doesn’t Have a Personal Need to:
(a) Share Experiences or Feelings, (b) Discuss the Relationship, or (c) Doesn’t Understand the Importance of Verbally Expressing to Partner Feelings of Love, Appreciation, or Praise
2. Talks, But Doesn’t Make Sure That the Partner is Listening
3. Faulty Patterns: (a) Speaker Mumbles, (b) Speaker is Ambiguous or Vague, (c) Listener Misinterprets, (d) Listener Mind-Reads
4. Doesn’t Reveal Self Due to Fear of Criticism or Attack
5. Believes That the Partner is Not Interested
6. Believes That Talking Would be Futile
7. Is Afraid of Starting a Fight
8. Makes Unilateral Decisions Due to Lack of Respect for Partner’s Opinion or by Default
9. Doesn’t Share Decision-Making Because of a Desire to Control
10. Couple Does Not Communicate Because of Incompatible Schedules, Heavy Workload, and Lack of Time Together
11. Communicates in an Offensive Manner
...
Although there had been much frustration and unhappiness on Janet’s part, she was aware that her husband had not been deliberately depriving her of her due, and there had been no ill will on Alvin’s part. The problem was that he had been ignorant of Janet’s needs and, consequently, ignorant of his obligation to fulfill them. However, once the matter was brought to his attention, he pulled himself out of his lethargic approach to romance, shed his old habits, and began looking at Janet and relating to her in a new way.
...
But even when she spoke to him from the same room, she was often unaware of how involved he was with the fast-moving action on the screen. Now, although it is true that Margie had told him what she claimed she had told him, she frequently failed to talk louder than the TV and often did not have his attention, much less his full attention.

It seems that on some occasions, Tom was not even aware that Margie was talking to him, much less he absorbed what she was trying to convey. But even on those occasions when he was aware of her presence, he was so engrossed in something else, such as trying to get his remote control to work, surfing the Internet, or doing take-home work, that he frequently failed to redirect his focus to pay attention to her. Margie’s problem was that she often approached Tom at the wrong time when his mind was elsewhere, and unknowingly did not get his attention. She mistakenly assumed that talking to him was communicating with him.
...
I explained to Tom how frustrating it was to Margie when she felt that talking to him was like talking to a wall. I further explained that this non-communication could take Margie beyond the anger stage and lead to a state of alienation. I then instructed the couple on some of the basic rules of communication, including the absolute requirement that the speaker get the target listener’s attention before communication begins. Margie became more sensitive to timing. She became acutely skilled at getting Tom’s attention before she asked him to do something or before she would give him instructions, e.g., on taking care of their baby or on some other important matter.

I also suggested more dependable ways of assuring her husband’s full attention, e.g., by getting him to agree to a nightly meeting with her after the children were asleep. This would afford the couple private time with each other and give them an opportunity to talk about whatever was on their minds.
...
2. A man offered to clean up the kitchen. Later, his wife asked him if he was “finished with the kitchen.” The husband was annoyed at the question because he interpreted it as a precursor to criticism that he had failed to do certain things and, in effect, had done a lousy job. He feared that her next words would be: “Well, if that’s what you call finished, I don’t. You forgot to…”

In fact, that was not on her mind. Her attitude when asking the question was a desire to be helpful. She had noticed that he had left certain things on the table, and she wanted to know whether she should put them away or leave them there since he may not be finished with them.
...
8. In a similar situation, a woman frequently asked her live-in fiancé how he felt about some of her ideas, plans, or various events in their life. His most usual answer was that he would have to think about it. She was hurt by this answer because she interpreted it as a brush-off. The man explained in our session that it was not his intention to brush her off. In the ensuing discussion, he expressed marvel at how quickly his fiancée knew exactly how she felt about something. He could not understand how she was able to know her emotions so quickly and so effortlessly. His personality was different. He was not in touch with his emotions, and he really did need time to think about a situation before he could tell her how he felt about it.
...
This state of affairs did not seem to bother Jack, but it bothered Martha.

She felt unimportant in the eyes of her husband because of his apparent disinterest in a very important part of her life. Sadly, she was unaware of how mistaken she was about this supposed attitude of Jack, nor was she aware of the role she was playing in maintaining Jack’s lack of communication with her on this subject.

Jack and Martha were not in touch with each other’s feelings, and a vicious cycle ensued. Martha didn’t tell about her activities at the hospital or her feelings about her patients and colleagues because she assumed that Jack was not interested. Since Martha did not initiate a discussion about clinic happenings, Jack mistakenly assumed that Martha didn’t really care to talk about her work experiences or her relationships with the veterans whom she was treating. Sadly, Martha came to the exact same conclusion about Jack’s failure to discuss his day with her.

Neither of them realized the role that each of them played in bringing about these two misunderstandings. Further, not only were they not communicating with each other about an important part of their lives, but they were also not communicating about their lack of communication.
...
There was an “explosion” of talk between them, and they were like two teenagers during their very first discovery of a “soul mate” with whom they could talk for hours. It would be an understatement to say that Martha and Jack began to enjoy a fuller and more satisfying relationship with each other.
...
In this scenario, it is not the fear of futility that stymies communication, but rather the fear of a fight. The fear is based on each person’s belief that their partner is short-tempered, extremely argumentative, stubborn, or just looking for a fight. Even in those situations where one or both partners were normally patient when they first met, they have now reached the end of their patience with each other.

The slightest spark sets off an explosion. After years of having failed to settle their differences by peaceful negotiation, they have concluded that they simply cannot handle disagreements without getting into a fight.
...
Consequently, he misses numerous opportunities to let his wife know that he would like her to change some of her behaviors so as to please him. His failure to communicate leaves her in the dark and robs her of the chance to enact constructive change to accommodate her husband’s wishes and needs.

As the honeymoon period fades away for married as well as unmarried people, the reality of living together with another person, with all of its concomitant frustrations, gradually settles in. Since it is normal for people to be unhappy when their needs or expectations are not met, it is crucial that the newlyweds, or the newly living together individuals who are not married, be adept at revealing their desires and frustrations to each other in a constructive manner.

If a person fails to bring his unhappiness to the attention of his partner in a constructive fashion, his concerns will not be addressed and the issues that bother him will remain unresolved.
...
During the few minutes that I spent alone with Keith during the couple’s first session, he confided to me that he did not wish to repair the marriage. He came only because of Kathy’s reaction to his leaving, and his wish to show her that he was not an uncaring person. He wished to provide her with the support that a marriage counselor would give, and add his own support by his presence at the weekly sessions.

Keith was truly concerned about the shock he had administered to Kathy and the pain he had caused her. He was compassionate in his understanding that her illusion of a happy marriage had been shattered. He was also aware that her day-to-day living would be more complicated in that she would now be solely responsible for the upkeep of the house and the care of their two dogs. But Keith confided that there was another reason why he came along for counseling. He was curious about the underlying causes of his failed marriage.

During the course of my sessions with the couple, Keith revealed that he hated confrontations. In his eyes, any complaint to his wife or criticism of her behavior would have constituted a confrontation, so he never said a word about his unhappiness. As the frustrations and dissatisfactions built up, Keith’s bottled-up resentments continued to grow until the pressure reached a force that he could no longer keep under control.

He lacked the communication skills to defuse the situation by addressing the problems, and he also lacked the stamina to live with the problems. Keith was caught in a bind. He saw separation and divorce as the only way out.
...
After listening carefully to Keith’s complaints against Kathy and after getting a good feel for his emotional state, I advised him that none of his marital problems seemed insurmountable and that it was clear to me that his erroneous thinking about marriage and his failure to employ rudimentary communication skills, including how to complain diplomatically, were causative factors in his marital failure. He needed to realize that both of these problems could be remedied.

I further explained that although he was free to separate from—or even permanently leave his wife if he so chose, his problems would go with him into any future relationship. It was clear that if he didn’t learn good communication skills now, with Kathy, he would have to start from scratch with his next partner. He accepted my evaluation and agreed that it was crucial for him to address his communication deficiencies.

I offered to coach him and suggested that, since Kathy was willing to talk to him about his unhappiness, he might as well take advantage of this opportunity to develop an ability to reveal his complaints and negative feelings to a woman. Keith agreed that he had nothing to lose and a lot to gain from the experience of taking his wife out to a weekly dinner meeting and discussing his hitherto unmentioned accumulated relationship problems with her.

Thus, he is committed to taking instruction in problem-solving tools and to practicing them on his wife despite their separation. I began his training during joint counseling sessions with the couple and encouraged both partners to meet outside my office to practice Keith’s newly acquired communication skills. Being convinced now that having problems is not an indication that two people are mismatched, and quickly learning that Kathy was more than ready to listen to his pent-up complaints and even willing to accommodate him on the issues that he raised with her, Keith began to look at his nearly defunct marriage in a new light.
...
a. A procrastinator,
b. Lacks alertness to sense a problem,
c. Has difficulty admitting that a problem exists even when another person directly confronts him with it,
d. Does not take initiative in deciding and formulating a solution even when facing a problem, he does not deny, or
...
All of the above-mentioned factors created friction from the very beginning of Meredith and Marshall’s marriage. A vicious cycle ensued: The unhappier Meredith became, the more insecure Marshall became about the future of the marriage, and the more reluctant he was to implement the two major changes that his wife demanded. These changes involved selling a house in which he had lived for many years and with which he was perfectly happy, and bringing a baby into what he considered an unstable marriage. His delays in these two important areas increased her unhappiness and strengthened the vicious cycle. Marshall’s refusal to give up control moved the formerly self-sufficient Meredith into an untenable position and contributed greatly to the instability of their fledgling marriage.
...
Some couples that I have worked with barely see each other during the week. When the weekend arrives, they are so overwhelmed with household duties and children that there is little alone time with each other. The communication that should take place between them is severely limited.

Sometimes, one member of the couple has frequent out-of-town assignments that separate the couple for days at a time. They may find it hard to keep in touch via telephone because of late meetings and different time zones that complicate the communication process. But even in those not-too-frequent cases where both husband and wife have a “normal” 9-5 routine with a not-too-exhausting commute, one, or both parents may be so burdened with take-home work from the office, household chores, caring for the children or spending quality time with them after the babysitter leaves that by the time they are finished with all their duties, they both flop into bed exhausted.
...
An infidelity shakes a marriage to its roots. Hopefully, this will send the couple into a mode of total mobilization. In this mode, they take a long, hard look at their marriage and assess its importance in their lives, with resultant growth and improvement.

The goal of marriage counseling is to jump from the infidelity to a mature re-evaluation, renaissance, and rebuilding of the relationship to a higher level than it was ever before. This elevated level of mutual understanding, appreciation, closeness, and renewed love constitutes the silver lining around the original cloud of despair, depression, hurt, anger, and pain.
...
In order for a marriage to succeed, each spouse must commit himself/herself to the happiness of his/her partner and express this in words and deeds. In this article, we have spoken at length about words; now, let’s talk about deeds. I am referring to the daily acts of kindness, sensitivity, and consideration that a loving spouse does for his partner. Loving behavior and deeds reflect the underlying emotions of a caring attitude and an acknowledgment of one’s partner’s importance and value.

When a positive attitude is supported by positive behavior, there will be an increase in love, closeness, and true friendship. Expressing your love with verbal and behavioral communication will start a benign cycle that will increase your partner’s caring behavior for you and create warm, dependable, trusting feelings and an everlasting love between both spouses.
  `
  },
  ...
  // Source: http://marriagecounselornj.com/infidelity-trust-issues/the-hurt-and-pain-of-infidelity/
  'hurt-and-pain-of-infidelity': {
    title: 'Achieve A Happy Togetherness After The Devastation Of An Infidelity',
    category: 'infidelity-trust-issues',
...
Sadly, this type of transgression is committed by both men and women, and various studies point to a rather high frequency. Statistics vary somewhat, but the following numbers are commonly reported: 20-28 percent of men admit they have cheated on their partners. However, when women are asked about their partner’s fidelity, including sex or just kissing, the number reported jumps to 46 percent. As regards the number of women who admit that they have been unfaithful to their partner the figure ranges from 10-15 percent.
...
Understandably, not all women react the same way to their husband’s infidelity, be it a physical and/or an emotional relationship. There is considerable variation both in the range and intensity of emotional reactions and behaviors on the part of the hurt spouse.

Some women report a sense of overwhelming sadness and even depression, which affects their ability to eat, sleep, concentrate, or focus on their responsibilities, including their job, children, family members and friends, household chores, as well as their other routine responsibilities. They also report loss of interest in life and very little pleasure, even when they try to immerse themselves in formerly pleasurable interests and activities. Many feel totally devastated, cry a lot at home, and even on the job. They are in a state of shock, disbelief, and bewilderment that this could have happened to them. They become disillusioned about their marriage. Their dream of total love and faithfulness has been shattered.

Wives who formerly thought that they were special and very precious to their husbands now fear that they are not. Some wonder whether their husband will eventually choose the other woman. Others feel discouraged about the future of their marriage because they are disgusted with their husband and don’t know if they will ever trust him again. These feelings cause them to lose faith in the relationship, and they consider separation or divorce.

Many women experience disrespect, belittlement, a loss of self-esteem, and see themselves as considerably less important or valued than they had seen themselves before the infidelity. They wonder in what way they have failed their husband, thus leading him to stray. They wonder if they are as precious or desirable as they have thought themselves to be until now.

Some feel embarrassed before family, friends, and neighbors, not knowing which people of this group know about the infidelity, what their thoughts are, and their opinion of how the hurt wife is handling the situation. They are wondering, “Why doesn’t she just throw him out? Why is she putting up with this?”
...
Other emotions include a sense of rejection, disrespect, great hurt, powerlessness, and above all, a sense of abandonment and betrayal. Frequently, the hurt spouse feels like she’s being twirled around by a tornado since her feelings may change from hour to hour, and she feels like she’s lost control of herself. At one moment, she may seek out her husband and feel as close to him as they were when they were first dating, but the next moment, she is so disgusted that she wants him out of her life.
...
I suggested she put off a final decision until the logical part of her brain is brought into the decision-making process. Feelings of rage, betrayal, depression, and a host of other painful and often contradictory emotions are perfectly normal.

As an aside, I remember the lawyer mentioned above very clearly. A mere three months later, she and her husband walked out of my office holding hands, smiling and happy as they had ever been before. In another couple that I saw, the woman, a school teacher, was so devastated that she couldn’t stop crying and was virtually falling apart. She did go to work but was barely effective in the classroom.
...
Would the former Governor of New York, Elliot Spitzer, have ever scheduled a tryst with a call girl at the Mayflower Hotel in Washington, D.C. if he had assigned due weight to the severity of his infidelity and the consequences? Did he ever envision the far-ranging media blitz about this one-night stand and the concurrent disclosure of other activities that embarrassed him and brought about his resignation from his position as Governor of New York State just a few days after the discovery was made? The emotional part of his brain (the limbic system) simply took over and totally excluded the prefrontal cortex, the seat of logic and reasoning.
...
The wisest of all men, King Solomon, says in Ecclesiastes that there is not a person alive who has not sinned. Some two thousand years ago, the Talmud spoke of personality forces that are essential for promoting society, but, when uncontrolled, bring havoc to the world.
...
Husbands who love their wives begin to feel the enormity of the hurt and harm they have done to their wives, and as the healing process progresses, they begin to feel their wives’ pain and suffer their own pain due to remorse and guilt about their infidelity. These men are willing to do anything to repair the damage to their wives, regain their love, and restore, as much as possible, the confidence and trust that they once had in them.

Other husbands, for a variety of reasons, are less sensitive to the pain they have caused but are well aware of the havoc they have caused. They, too, have no thought of divorce and are also willing to seek out professional help and do what they can to remedy the situation, but perhaps with less enthusiasm. No two cases are the same.
  `
  },
  // Source: http://marriagecounselornj.com/infidelity-trust-issues/12-ii-section-2/
  'infidelity-like-earthquake': {
    title: 'An Infidelity To A Marriage Is Like An Earthquake To A House',
    category: 'infidelity-trust-issues',
    categoryName: 'Infidelity & Trust Issues',
    articleNumber: 'II',
    content: `
Before reading this article I recommend you read Article 1 “Achieve A Happy Togetherness After The Devastation Of An Infidelity.” Click Here
...
In view of the fact that Tokyo has a long history of earthquakes, houses in Tokyo are required to be built so as to suffer minimal or no damage should there be an earthquake. Clearly, houses that do not abide by the building code may absolutely collapse. And so it is with marriages. Some relationships can weather a high-level earthquake on the Richter Scale, but others will not withstand even a “low level” tremor.
...
As part of your training in communication, you will learn the “Talk/Listen Technique” and you will practice it with your partner under my supervision. One of you will choose a new –or an old– but unsolved personal complaint or problem, and you and your partner will discuss it calmly and thoroughly within the structure of your newly learned “Talk/Listen Technique.” In this mode of discussion, disagreements and arguments are processed within a safe and secure structure. The technique also guarantees each person an equal opportunity to participate since both partners take turns at talking and listening. This effective mode of arguing gives each partner an opportunity to express himself in full detail while also making sure that his partner listened and understood everything that he said.
  ...
  // Source: http://marriagecounselornj.com/infidelity-trust-issues/13-iii-section-3/
  'easy-to-begin-secret-relationship': {
    title: 'In Today\'s High Tech Era, It Is Easy To Begin a Secret Relationship, But Also Easy To Be Discovered',
    category: 'infidelity-trust-issues',
    categoryName: 'Infidelity & Trust Issues',
    articleNumber: 'III',
    content: `
...
Often, infidelity takes place in a marriage that is vulnerable. However, infidelities can also occur even in marriages where both spouses thought they were happy in the relationship. But even if a marriage was considered “good” by both parties, after going through a properly conducted healing process by an experienced professional, following infidelity, the marriage can become a lot richer, stronger, more mature, fulfilling, and satisfying in many different ways. It can end up better than it ever was and stay at a loftier level for the rest of its existence. More on this in my article Can There Be A Silver Cloud Around The Cloud Of An Infidelity?”
  ...
  // Source: http://marriagecounselornj.com/19-growing-a-couples-loving-relationship/20-i-happily-ever-after/
  'happily-ever-after': {
    title: 'Happily Ever After?',
    category: 'growing-loving-relationship',
...
For More “Growing a Couple’s Loving Relationships” article pls click here.
...
How do such romantic declarations grab the modern suitor? Is the love that today’s 21st-century singles demand, before committing to a marriage (experiences so beautifully described by English poets in their rapturous sonnets) equal to their fantasized loves?
...
So, is there a case for love? I think so. But admittedly romantic love fades and even true love does not conquer all; it will not sustain a relationship under all challenges. On the other hand, love can be a powerfully motivating force to initiate a committed relationship, and an incentive to do everything you can to explore it, remedy it, nurture it, and preserve it.
  ...
  // Source: http://marriagecounselornj.com/19-growing-a-couples-loving-relationship/22-iii-the-hidden-agenda-in-relationships/
  'hidden-agenda-in-relationships': {
    title: 'The Hidden Agenda in Relationships',
    category: 'growing-loving-relationship',
    categoryName: 'Growing a Couple\'s Loving Relationship',
    articleNumber: 'III',
    content: `
...
## 3. Expectations That Are Unconscious i.e. Not on The Person's Mind And Therefore Not Verbalized
...
Hidden agendas do not remain dormant; they eventually emerge; and when they do, they cause surprises, and often problems, but they do not need to destroy a relationship. When they are addressed directly, reciprocal accommodation can take place. As long as there is mutual care and concern, loving members of a couple will find a way to freely express their needs to each other and make reasonable attempts to fulfill them. In most cases their efforts will be amply rewarded.
  ...
  // Source: http://marriagecounselornj.com/19-growing-a-couples-loving-relationship/23-iv-im-married-but-feel-alone/
  'married-but-feel-alone': {
    title: 'I\'m Married But Feel Alone: We Barely Talk',
    category: 'growing-loving-relationship',
    categoryName: 'Growing a Couple\'s Loving Relationship',
    articleNumber: 'IV',
    content: `
...
## 2. Need For The Creation of an Assessment Form To Measure a Couple's Relationship-Building Communications
...
## 4. Goals of This Assessment Form
...
Spouses do not need to go through life feeling distant or disconnected from their partners because of a lack of relationship-building constructive overtures. Individuals who seek greater closeness and intimacy with their partners can achieve their goals with each other including mutual understanding of each other’s wishes and needs as expressed by clear-cut and bonding-communications.
  `
  },
  // Source: http://marriagecounselornj.com/19-growing-a-couples-loving-relationship/24-v-language-deficit-reflects-conceptual-deficit/
  'language-deficit-conceptual-deficit': {
    title: 'Language Deficit Reflects Conceptual Deficit: Satisfying Each Other\'s Wishes & Needs',
    category: 'growing-loving-relationship',
    categoryName: 'Growing a Couple\'s Loving Relationship',
    articleNumber: 'V',
    content: `
...
For more articles on “Growing a Couple’s Loving Relationships” please click here.
...
BergenMarriage1@gmail.com
  ...
  'easy-to-get-married-hard-to-stay': {
    title: 'So Easy To Get Married But So Hard To Stay Married Happily',
    category: 'growing-loving-relationship',
    categoryName: 'Growing a Couple\'s Loving Relationship',
    articleNumber: 'VI',
    content: `
...
For information on premarital counseling please click here for “The Counseling Process”.
  ...
  // Source: http://marriagecounselornj.com/26-spouse-resists-counseling/27-i-different-levels-of-motivation/
  'different-levels-of-motivation': {
    title: 'Different Levels of Motivation to Maintain the Relationship',
    category: 'spouse-resists-counseling',
    categoryName: 'Spouse Resists Counseling',
    articleNumber: 'I',
    content: `
...
For more articles on “Spouse Resists Counseling,” click here.
...
BergenMarriage1@gmail.com
  ...
  'only-one-person-motivated': {
    title: 'What if Only One Person is Motivated?',
    category: 'spouse-resists-counseling',
    categoryName: 'Spouse Resists Counseling',
    articleNumber: 'II',
    content: `
...
I also work with couples who are separated, and are exploring getting together again, but wish to resolve the issues that split them up in the first place. I will also work with you on issues that stem from conflicts of values and philosophy originating in personality, or different religious, ethnic or cultural backgrounds. Please click here for “Different Levels of Motivation to Maintain The Relationship”
  ...
  'fourteen-helpful-answers': {
    title: 'Fourteen Helpful Answers To A Spouse Who Resists Marriage Counseling',
    category: 'spouse-resists-counseling',
    categoryName: 'Spouse Resists Counseling',
    articleNumber: 'III',
    content: `
...
It Is Humiliating to Seek Help

Needing Help Means That We Have Failed

It Is A Sign of Weakness To Seek Help

Only Crazy People Go For Counseling

People Should Be Able To Solve Their Own Marital Problems

If We Are Having Problems It Means We Weren’t Meant For Each Other

People Should Get Married And Live Happily Ever After Without Problems

Our Marital Problems Are Your Fault; I’m Fine. You Need The Counseling

Why Bother? The Problems Will Solve Themselves.

I’m An Adult. Nobody Is Going To Tell Me What To Do

I Don’t Believe In Counseling

I Tried It When I Was Younger And It Didn’t Work
...
We have open minds to recognize these problems, and
...
How long will it take before they start thinking to themselves at some level:
“If this is what marriage is all about, count me out!”?
...
export const articlesList = [
  // Marriage Counseling Process
  { id: 'brief-overview', title: 'Brief Overview of the Marriage and Couple Counseling Process', category: 'marriage-counseling-process', excerpt: 'Since I am not part of a hospital or psychological clinic, but rather a marriage counselor and psychologist in privat...', order: 1 },
  { id: 'why-isnt-love-enough', title: 'Why Isn\'t Love Enough?', category: 'marriage-counseling-process', excerpt: 'Even when both partners are in love with each other when they begin their exclusive relationship, a breakdown may occ...', order: 2 },
  { id: 'hope-for-troubled-marriages', title: 'Hope for Troubled Relationships: A Detailed Description of the Marriage/Couple Counseling Process', category: 'marriage-counseling-process', excerpt: 'Getting the message across to the other person is the essence of communication.', order: 3 },
  { id: 'assessing-happiness', title: 'Assessing Each Person\'s Feelings About the Relationship', category: 'marriage-counseling-process', excerpt: 'This article describes the parameters of an informal assessment scale that I introduce to each spouse, when I ask the...', order: 4 },
  // Effective Communication
  { id: 'how-to-complain-diplomatically', title: 'Avoid Fights and Keep the Peace: Complain and Even Argue in a Friendly Manner', category: 'effective-communication', excerpt: 'Angry complaints and insulting or nasty arguments will weaken your relationship while freiendly ones will strengthen it.', order: 5 },
  { id: 'talking-isnt-communicating', title: 'Talking Isn\'t Always Communicating', category: 'effective-communication', excerpt: 'You can talk to a wall but not communicate with a wall.', order: 6 },
  { id: 'abc-should-be-the-same', title: 'The A-B-C\'s of Good Communication: A, B, & C Should Always Be the Same', category: 'effective-communication', excerpt: 'Summary: Both speaker and listener play an important role in bringing about good communication.', order: 7 },
  { id: 'abc-not-always-the-same', title: 'Communication Fails When A, B, & C Are Not the Same', category: 'effective-communication', excerpt: 'Often, the speaker does not say what is on his mind, or, if he does, he fails to get his point across, leading to a breakdown in communication.', order: 8 },
  { id: 'benefits-of-good-communication', title: 'Six Important Benefits of Good Communication', category: 'effective-communication', excerpt: 'Good communication will help you Enhance Positive and Decrease Negative interactions with your partner by enabling bo...', order: 9 },
  { id: 'reasons-spouses-fail-to-communicate', title: 'Thirteen Reasons Why Spouses Fail to Communicate Effectively', category: 'effective-communication', excerpt: '“All the world is on the tip of the tongue” —Talmud, Brachot', order: 10 },
  // Infidelity & Trust Issues
  { id: 'hurt-and-pain-of-infidelity', title: 'Achieve A Happy Togetherness After The Devastation Of An Infidelity', category: 'infidelity-trust-issues', excerpt: 'There are so many challenges, varying in the extent of their difficulty, that a couple faces during the course of the...', order: 11 },
  { id: 'infidelity-like-earthquake', title: 'An Infidelity To A Marriage Is Like An Earthquake To A House', category: 'infidelity-trust-issues', excerpt: 'I generally tell my clients that infidelity in a relationship is like an earthquake to a house.', order: 12 },
  { id: 'easy-to-begin-secret-relationship', title: 'In Today\'s High Tech Era, It Is Easy To Begin a Secret Relationship, But Also Easy To Be Discovered', category: 'infidelity-trust-issues', excerpt: 'Although men cheat more frequently, women also cheat.', order: 13 },
  // Growing a Couple's Loving Relationship
  { id: 'happily-ever-after', title: 'Happily Ever After?', category: 'growing-loving-relationship', excerpt: 'Once upon a time when one heard the phrase; “They got married and .', order: 14 },
  { id: 'love-conquers-all', title: 'Love Conquers All?', category: 'growing-loving-relationship', excerpt: 'Although beautifully described in the Bible, particularly in Solomon’s “Song of Songs,” romantic love was not a commo...', order: 15 },
  { id: 'hidden-agenda-in-relationships', title: 'The Hidden Agenda in Relationships', category: 'growing-loving-relationship', excerpt: 'All relationships have hidden agendas or unexpressed expectations.', order: 16 },
  { id: 'married-but-feel-alone', title: 'I\'m Married But Feel Alone: We Barely Talk', category: 'growing-loving-relationship', excerpt: 'This article addresses the issues of women who say “My husband is quiet,” “We barely talk,” ” We’re like two ships pa...', order: 17 },
  { id: 'language-deficit-conceptual-deficit', title: 'Language Deficit Reflects Conceptual Deficit: Satisfying Each Other\'s Wishes & Needs', category: 'growing-loving-relationship', excerpt: 'Summary: What does a group’s language tell us about the importance of certain physical phenomena or the social/cultur...', order: 18 },
  { id: 'easy-to-get-married-hard-to-stay', title: 'So Easy To Get Married But So Hard To Stay Married Happily', category: 'growing-loving-relationship', excerpt: 'Introduction: The theme of this article is that individuals go into marriage without knowing what they are getting into.', order: 19 },
  // Spouse Resists Counseling
  { id: 'different-levels-of-motivation', title: 'Different Levels of Motivation to Maintain the Relationship', category: 'spouse-resists-counseling', excerpt: 'In this category, the two individuals that come for counseling, be they married, living together, or just dating in a...', order: 20 },
  { id: 'only-one-person-motivated', title: 'What if Only One Person is Motivated?', category: 'spouse-resists-counseling', excerpt: 'Sometimes there is doubt in the heart of one person whether or not to stay in the relationship/marriage and/or inabil...', order: 21 },
  { id: 'fourteen-helpful-answers', title: 'Fourteen Helpful Answers To A Spouse Who Resists Marriage Counseling', category: 'spouse-resists-counseling', excerpt: 'The purpose of this article is to help an unhappy partner, husband or wife, in their efforts to convince their reluct...', order: 22 },
];

export const categories = [
  { id: 'all', name: 'All Articles' },
  { id: 'marriage-counseling-process', name: 'Marriage Counseling Process' },
  { id: 'effective-communication', name: 'Effective Communication' },
  { id: 'infidelity-trust-issues', name: 'Infidelity & Trust Issues' },
  { id: 'growing-loving-relationship', name: 'Growing a Couple\'s Loving Relationship' },
  { id: 'spouse-resists-counseling', name: 'Spouse Resists Counseling' },
];
